...
def generateGraphics(data,fileOutput):
	...
	fig1.savefig('50-100'+fileOutput+'.svg',bbox_extra_artists=(lgd,lgd2),bbox_inches='tight',format="svg")	
	...
	fig2.savefig('200-500'+fileOutput+'.svg',bbox_extra_artists=(lgd,lgd2),bbox_inches='tight',format="svg")	
